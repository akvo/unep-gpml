...
const Organisation = ({ isAuthenticated, setLoginVisible, profile }) => {
  ...
  const fetchData = async (page, limit, status, append = false) => {
    setLoading(true)
    try {
      const result = await fetchSubmissionData(page, limit, 'entities', status)
  ...
  const showDeleteConfirm = (record) => {
    ...
    confirm({
      title: 'Are you sure you want to decline this organisation?',
      okText: 'Decline',
      okType: 'danger',
      cancelText: 'Cancel',
      cancelButtonProps: {
        ...
        return api
          ...
          .then(() => {
            notification.success({
              message: 'Organisation declined successfully',
            })
            setData((prevData) =>
  ...
  const approveOrganisation = (record) => {
    ...
    api
      .put(`/submission`, approveOrganisation)
      .then(() => {
        notification.success({ message: 'Organisation approved successfully' })
