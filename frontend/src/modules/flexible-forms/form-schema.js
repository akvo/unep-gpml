        ...
        S4: {
          ...
          properties: {
            ...
            S4_G2: {
              ...
              properties: {
                geoCoverageType: {
                  title: i18n._(t`Select Geo-Coverage Type`),
                  type: 'string',
                ...
                'S4_G2_24.3': {
                  title: i18n._(t`GEO COVERAGE (Transnational)`),
                  type: 'string',
                  enum: [],
                  enumNames: [],
                  depend: {
                ...
                'S4_G2_24.4': {
                  title: i18n._(`GEO COVERAGE (Countries)`),
                  type: 'string',
                  enum: [],
                  enumNames: [],
                  depend: {
                ...
                geoCoverageValueSubnational: {
                  title: i18n._(t`Select a country`),
                  enum: [],
                  depend: {
                    id: 'geoCoverageType',
                    value: ['sub-national'],
            ...
            S4_G4: {
              ...
              properties: {
                image: {
                  title: i18n._(t`Banner`),
                  type: 'string',
                  format: 'data-url',
                },
                thumbnail: {
                  title: i18n._(t`Thumbnail (300x400)`),
                  type: 'string',
                  format: 'data-url',
                },
              },
            ...
            S4_G5: {
              ...
              properties: {
                entity: {
                  title: i18n._(t`Entity connection`),
                  description: 'entity',
                  custom: 'entity',
                  type: 'array',
                  items: {
                ...
                individual: {
                  title: i18n._(t`Individual connection`),
            ...
            S4_G6: {
              ...
              properties: {
                info: {
                  title: i18n._(t`Info And Docs`),
                  type: 'string',
                },
                related: {
                  title: i18n._(t`Related Resource`),
                  enum: [],
                  enumNames: [],
                },
              },
