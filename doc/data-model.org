...
#+begin_src sql
INSERT INTO geo_coverage(geo) VALUES('global');
#+end_src
...
#+begin_src sql
INSERT INTO country(name) VALUES ('Global'), ('Kenya');
#+end_src
...
VALUES ('Mr.', 'Saiful', 'Ridwan', 'UNEP',
        'https://www.linkedin.com/in/saiful-ridwan-b3342516/',
        'saiful.ridwan@un.org', 1, 'UN');
#+end_src
...
|----+---------+-------+------------+-----------+-------------+----------------------+-----------------------------------------------------+---------+-----+---------+----------------+---------+--------------|
|  1 |         | Mr.   | Saiful     | Ridwan    | UNEP        | saiful.ridwan@un.org | https://www.linkedin.com/in/saiful-ridwan-b3342516/ |         |     |       1 | UN             |         |              |

#+begin_src sql
INSERT INTO stakeholder(title, first_name, last_name, affiliation,
                        linkedin, email, country, representation,
                        summary, geo_coverage)
VALUES ('Ms.', 'Caroline', 'Kamau', 'UNEP', 'https://www.linkedin.com/in/caroline-kamau',
        'caroline.kamau@un.org', 2, 'UN', 'Machine Learning Developer', 3),
       ('Ms.', 'Marta', 'Ottogalli', 'UNEP', 'https://www.linkedin.com/in/marta-ottogalli/', 'marta.ottogalli@un.org',
...
|----+---------+-------+------------+-----------+-------------+------------------------+-----------------------------------------------------+---------+-----+---------+----------------+-----------------------------------------------------------+--------------|
|  1 |         | Mr.   | Saiful     | Ridwan    | UNEP        | saiful.ridwan@un.org   | https://www.linkedin.com/in/saiful-ridwan-b3342516/ |         |     |       1 | UN             |                                                           |              |
|  4 |         | Ms.   | Caroline   | Kamau     | UNEP        | caroline.kamau@un.org  | https://www.linkedin.com/in/caroline-kamau          |         |     |       2 | UN             | Machine Learning Developer                                |            3 |
|  5 |         | Ms.   | Marta      | Ottogalli | UNEP        | marta.ottogalli@un.org | https://www.linkedin.com/in/marta-ottogalli/        |         |     |       1 | UN             | Product and Knowledge Manager at UN Environment Programme |              |
...
|----+---------------------------------+-------------------------------+-------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----+-----------+--------------+---------|
|  2 | Towards a GPML digital platform | 2020-12-24 09:49:01.006098+00 | 2020-12-24 09:49:01.006098+00 | The webinar "Towards a GPML Digital Platform” offered a high-level overview of the forthcoming GPML Digital Platform, as well as an opportunity to discuss multi-stakeholder functionalities, the data aspects and feedback. |     | {English} |            3 |         |
...
#+begin_src sql
INSERT INTO tag_category(category) VALUES('general');
INSERT INTO tag_category(category) VALUES('technology');
#+end_src
...
|----------------------+---------------------------------+---------------|
| saiful.ridwan@un.org | Towards a GPML digital platform | interested in |
