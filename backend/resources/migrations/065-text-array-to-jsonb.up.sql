...
ALTER TABLE resource ALTER COLUMN attachments TYPE jsonb USING to_jsonb(attachments);
ALTER TABLE policy ALTER COLUMN attachments TYPE jsonb USING to_jsonb(attachments);
ALTER TABLE technology ALTER COLUMN attachments TYPE jsonb USING to_jsonb(attachments);
