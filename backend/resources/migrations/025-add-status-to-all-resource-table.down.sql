ALTER TABLE stakeholder RENAME COLUMN reviewed_at TO approved_at;
ALTER TABLE stakeholder DROP COLUMN reviewed_by;
ALTER TABLE stakeholder DROP COLUMN review_status;

ALTER TABLE event RENAME COLUMN reviewed_at TO approved_at;
ALTER TABLE event RENAME COLUMN reviewed_by TO approved_by;
ALTER TABLE event DROP COLUMN review_status;

ALTER TABLE resource DROP COLUMN reviewed_at;
ALTER TABLE resource DROP COLUMN reviewed_by;
ALTER TABLE resource DROP COLUMN review_status;

ALTER TABLE policy DROP COLUMN reviewed_at;
ALTER TABLE policy DROP COLUMN reviewed_by;
ALTER TABLE policy DROP COLUMN review_status;

ALTER TABLE project DROP COLUMN reviewed_at;
ALTER TABLE project DROP COLUMN reviewed_by;
ALTER TABLE project DROP COLUMN review_status;

ALTER TABLE technology DROP COLUMN reviewed_at;
ALTER TABLE technology DROP COLUMN reviewed_by;
ALTER TABLE technology DROP COLUMN review_status;
