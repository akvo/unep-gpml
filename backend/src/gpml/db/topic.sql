...
UNION ALL
    ...
    i.qimage AS image,
    NULL AS logo,
    i.q24::text AS geo_coverage_type,
    NULL AS attachments,
    NULL AS remarks,
    i.created,
    i.modified,
    i.q23::text AS country,
    NULL AS city,
    NULL AS type_of_law,
    NULL AS organisation_type,
    NULL AS development_stage,
    ...
    NULL AS latest_amendment_date,
    NULL AS status,
    i.q24_subnational_city AS subnational_city,
    NULL AS headquarter,
    NULL::int AS language,
    i.document_preview,
...
UNION ALL
  SELECT
    ...
    p.created_by,
    p.url,
    p.regulatory_approach,
    p.toolkit_legislation,
    p.repeals,
    p.publication_reference,
    p.info_docs,
    p.sub_content_type,
    NULL AS capacity_building,
    NULL AS event_type,
