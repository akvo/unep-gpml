...
(def ^:const review-statuses
  "Stakeholder possible `review_status` values."
  #{"APPROVED" "SUBMITTED" "REJECTED"})

(def ^:const geo-coverage-types
  "Stakeholder's possible `geo_coverage_type` values."
