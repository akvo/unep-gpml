  ...
  [:and
   (into
    [:map
     ...
     [:gallery {:optional true} [:vector {:optional true} [:fn (comp util/base64? util/base64-headless)]]]
     [:videos {:optional true} [:vector {:optional true} any?]]
     [:background {:optional true} string?]
     [:purpose {:optional true} string?]
     [:highlights {:optional true} [:vector {:optional true} any?]]
     [:outcomes {:optional true} [:vector {:optional true} any?]]
